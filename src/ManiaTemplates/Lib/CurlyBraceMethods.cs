...
public class CurlyBraceMethods: ICurlyBraceMethods
{
    protected static readonly Regex TemplateInterpolationRegex = ICurlyBraceMethods.TemplateInterpolationRegex;
