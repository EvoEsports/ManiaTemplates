    ...
    <template>
        <frame pos="{{ x }} {{ y }}" z-index="{{ z }}">
            <frame pos="{{ w }} 0" size="10 10" rot="90" scale="{{ r }}">
                <quad pos="-.15 0.15" size="20 20" modulatecolor="{{ color }}" image="file:///Media/Painter/Stencils/01-EllipseRound/Brush.tga"/>
            </frame>
            ...
            <quad pos="{{ r * 10.0 }} 0" size="{{ w - r * 20.0 }} {{ r * 10.0 }}" bgcolor="{{ color }}" />
            <quad pos="0 {{ r * -10.0 }}" size="{{ w }} {{ h - r * 20.0 }}" bgcolor="{{ color }}" />
            <quad pos="{{ r * 10.0 }} {{ h * -1.0 + r * 10.0 }}" size="{{ w - r * 20.0 }} {{ r * 10.0 }}" bgcolor="{{ color }}" halign="bottom" />
        </frame>
    </template>
</component>
